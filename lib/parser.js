...
export const projectType = {
  'ableton': 'ableton-project' 
} 

export const ignoreRules = {
    [projectType.ableton] : 'Backup/*'
}

const fileTypeRegex = {
  [projectType.ableton]: '*.als',
}

const fileExtType = {
  '.als': projectType.ableton,
}
...
export class ParserManager {
  ...
  async init() {
    if (this.type === projectType.ableton) {
  ...
  static getProjectFiles(dirPath) {
    // TODO: make ignore more generic for all types of projects
    let option = {
      cwd: dirPath,
      ignore: [ignoreRules[projectType.ableton]],
      absolute: true,
    };
    let files = {}
